...
**AWS Services Used:**
- EC2
- VPC (pre-provisioned via CloudFormation)
- Security Groups
...
- The MySQL service on the EC2 instance is stopped/removed
...
- The ASG uses the Launch Template (from Stage 2, updated for EFS) to provision instances
...
**Why this stage matters:**
This is the final, production-grade architecture. It is:
- **Resilient:** Survives instance failures automatically
- **Scalable:** Handles variable load without manual intervention
- **Highly Available:** Spans multiple Availability Zones
