...
- Instance types (we use t2.micro / t3.micro)
...
**Key concepts for this project:**
- Listener rules (port 80 → Target Group)
...
**Used in:** Base infrastructure provisioning (provided by Adrian Cantrill's lab)
...
**Key concepts for this project:**
- Web tier SG: allows port 80/443 from internet
